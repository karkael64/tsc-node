...
const commandOptions = {
    ...
    cacheFolder: buildCommandOption(["-f", "--cacheFolder"], "Define the folder for javacript generated files", "path", "detached"),
    keepCache: buildCommandOption(["-k", "--keepCache"], "Tell that you want to keep cache at the end of execution"),
...
export const command = buildCommand(commandDescription, commandOptions, commandExamples);
export const helper = `${command}`;
//# sourceMappingURL=tsc-node.command-line.js.map