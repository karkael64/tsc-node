...
async function getArgs() {
    const args = process.argv.slice(process.argv.findIndex((arg) => arg === __filename) + 1);
...
async function tscompile(entry, outDir, tsconfig = []) {
...
async function main() {
    ...
    const { tsfile, tsconfig, cacheFolder = "./node_modules/.tsc-node", keepCache, verbose, } = result;
...
main()
    ...
    .catch(console.error);
//# sourceMappingURL=tsc-node.js.map